...
#' }
#'
#' @source List of women in statistics—Wikipedia. Retrieved October 1, 2025, from \href{https://en.wikipedia.org/wiki/List_of_women_in_statistics}{Wikipedia}
#'
"women_in_statistics"
